          ...
          <div className="-mx-4 flex flex-wrap items-center">
            <div className="w-full px-4 lg:w-1/2">
              ...
              <SectionTitle
                ...
                paragraph="WebaholicTech specializes in sophisticated technology, creating custom websites that reflect your unique branding. If you have a proven track record, trust us for innovative solutions that increase your online presence."
                mb="44px"
              />
